...
EtResurrexitSoprano = {
  \relative c' {
    ...
    r8 \mvTr h'\fE^\tuttiE h h a a a a
    h h e d16 e cis4 d8 d
    d^\critnote e16 e cis4 d r %90
    R1
    d8([ fis16 e] d8) cis d([ fis16 e)] d8 cis
    d4 a a ais8 ais
    h8. h16 cis8 cis h h16 h h8([ ais)]
    h4 r r8 a a8. a16 %95
    a8 a a8. a16 a8 a a8. a16
    h4 h8 e c!4 c
    c2 h8 h h4~
    h a h h8 h
    c4 c8 c h h h4 %100
    h r r2
    R1*12 %113
    r2 r8 \mvTr c\fE^\tutti d e
    f4 e8 c c d h8. h16 %115
    c8 g a h c8. c16 h8 h
    a4. gis8 a4 r
    r8 a d8. c16 h4 h
    r g8 g fis2
    e4 r d'!4. e8 %120
...
SanctusSoprano = {
  \relative c' {
    ...
    \time 3/4 \tempoPleni \mvTr d4\pE^\soloE h e \noBreak
    d d c
    h a d~
    d cis2 %10
    d r4
    r d8[ c h a]
    h[ a] g4 h~
    h8[ cis16 d] e8[ d cis h]
    ais4 h cis %15
    d( cis2) \noBreak
    h2.\fermata \bar "||"
    \time 2/2 \tempoOsanna r2 \mvTr d\fE^\tuttiE
    h g
    r e'4 e %20
    e2 d
    r d4 d
...
AgnusSoprano = {
  \relative c' {
    ...
    r4 \mvTr g'8\fE^\tuttiE g d'2
    d4 d h h
    r8 h h e cis2
    d2 dis4 dis
    e2. d4 %5
    cis2 h
    r4 \mvTr d8\pE^\soloE d d4 cis8 cis
    h4 h8 h h4 a8 a
    a4 g g fis
    r2 e'8 d c h %10
    a2 g
